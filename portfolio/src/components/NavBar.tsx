...
const NavBar = () => {
    return (
        <nav className="flex fixed z-2 bg-earth-green px-10 w-full h-16 items-center justify-between">
            <div className="flex-none">
                { /** Clicking on the image should bring you to the top of the page */}
                <Image src={ signature } alt="signature" className="max-w-48"/>
            </div>
            <div className="flex gap-10 font-koulen text-4xl text-earth-white">
